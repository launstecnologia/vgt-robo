#!/usr/bin/env python3
"""
Robô NÃO PAGOS — Baixa apenas planilhas de situação Não Pagos.
Uso: python main_nao_pagos.py [ADDAD] [AGNELLO] ...
     python main_nao_pagos.py --nome ADDAD
"""
import argparse
from app.robo_core import executar, filtrar_por_nome, IMOBILIARIAS_EVENTOS

if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Robô NÃO PAGOS — Download de planilhas Não Pagos")
    ...
    if nomes_busca and not imobiliarias:
        ...
        exit(1)
    executar("nao_pagos", imobiliarias, data_inicio=args.data_inicio, data_fim=args.data_fim)
